    ...
    const bool _VERBOSE)
{
    ...
    // Create the RDF with energy bin
    ...
    auto h_BGOrec_raw_energy = _fr_bgo_analysis.Define("raw_energy_gev", "energy * 0.001")
                                   .Histo1D<double, double>({"h_BGOrec_raw_energy", "BGO Raw energy", energy_nbins, &energy_binning[0]}, "raw_energy_gev", "simu_energy_w");
    auto h_BGOrec_corr_energy = _fr_bgo_analysis.Define("corr_energy_gev", "energy_corr * 0.001")
                                    .Histo1D<double, double>({"h_BGOrec_corr_energy", "BGO Corr energy", energy_nbins, &energy_binning[0]}, "corr_energy_gev", "simu_energy_w");
    auto h_BGOrec_cosine = _fr_bgo_analysis.Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                               .Histo1D<double, double>({"h_BGOrec_cosine", "BGO Reco cosine", 100, 0, 1}, "bgorec_cosine", "simu_energy_w");
    ...
    auto h_BGOrec_sumRms_bin_cosine2D_20_100 = _fr_bgo_analysis.Define("corr_energy_gev", "energy_corr * 0.001")
                                                   ...
                                                   .Histo2D<double, double, double>({"h_BGOrec_sumRms_bin_cosine2D_20_100", "sumRms - cos(#theta) correlation 20 GeV - 100 GeV; cos(#theta); sumRms [mm]", (int)cosine_bins.size() - 1, &cosine_bins[0], (int)sumRms_binning.size() - 1, &sumRms_binning[0]}, "bgorec_cosine", sumRms_leaf.c_str(), "simu_energy_w");
    auto h_BGOrec_sumRms_bin_cosine2D_100_250 = _fr_bgo_analysis.Define("corr_energy_gev", "energy_corr * 0.001")
                                                    ...
                                                    .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                    .Histo2D<double, double, double>({"h_BGOrec_sumRms_bin_cosine2D_100_250", "sumRms - cos(#theta) correlation 20 GeV - 100 GeV; cos(#theta); sumRms [mm]", (int)cosine_bins.size() - 1, &cosine_bins[0], (int)sumRms_binning.size() - 1, &sumRms_binning[0]}, "bgorec_cosine", sumRms_leaf.c_str(), "simu_energy_w");
    auto h_BGOrec_sumRms_bin_cosine2D_250_500 = _fr_bgo_analysis.Define("corr_energy_gev", "energy_corr * 0.001")
                                                    ...
                                                    .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                    .Histo2D<double, double, double>({"h_BGOrec_sumRms_bin_cosine2D_250_500", "sumRms - cos(#theta) correlation 20 GeV - 100 GeV; cos(#theta); sumRms [mm]", (int)cosine_bins.size() - 1, &cosine_bins[0], (int)sumRms_binning.size() - 1, &sumRms_binning[0]}, "bgorec_cosine", sumRms_leaf.c_str(), "simu_energy_w");
    auto h_BGOrec_sumRms_bin_cosine2D_500_1000 = _fr_bgo_analysis.Define("corr_energy_gev", "energy_corr * 0.001")
                                                     ...
                                                     .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                     .Histo2D<double, double, double>({"h_BGOrec_sumRms_bin_cosine2D_500_1000", "sumRms - cos(#theta) correlation 20 GeV - 100 GeV; cos(#theta); sumRms [mm]", (int)cosine_bins.size() - 1, &cosine_bins[0], (int)sumRms_binning.size() - 1, &sumRms_binning[0]}, "bgorec_cosine", sumRms_leaf.c_str(), "simu_energy_w");
    auto h_BGOrec_sumRms_bin_cosine2D_1000_3000 = _fr_bgo_analysis.Define("corr_energy_gev", "energy_corr * 0.001")
                                                      ...
                                                      .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                      .Histo2D<double, double, double>({"h_BGOrec_sumRms_bin_cosine2D_1000_3000", "sumRms - cos(#theta) correlation 20 GeV - 100 GeV; cos(#theta); sumRms [mm]", (int)cosine_bins.size() - 1, &cosine_bins[0], (int)sumRms_binning.size() - 1, &sumRms_binning[0]}, "bgorec_cosine", sumRms_leaf.c_str(), "simu_energy_w");
    auto h_BGOrec_sumRms_bin_cosine2D_3000_10000 = _fr_bgo_analysis.Define("corr_energy_gev", "energy_corr * 0.001")
                                                       ...
                                                       .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                       .Histo2D<double, double, double>({"h_BGOrec_sumRms_bin_cosine2D_3000_10000", "sumRms - cos(#theta) correlation 20 GeV - 100 GeV; cos(#theta); sumRms [mm]", (int)cosine_bins.size() - 1, &cosine_bins[0], (int)sumRms_binning.size() - 1, &sumRms_binning[0]}, "bgorec_cosine", sumRms_leaf.c_str(), "simu_energy_w");
    auto h_BGOrec_sumRms_bin_cosine2D_10000_20000 = _fr_bgo_analysis.Define("corr_energy_gev", "energy_corr * 0.001")
                                                        ...
                                                        .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                        .Histo2D<double, double, double>({"h_BGOrec_sumRms_bin_cosine2D_10000_20000", "sumRms - cos(#theta) correlation 20 GeV - 100 GeV; cos(#theta); sumRms [mm]", (int)cosine_bins.size() - 1, &cosine_bins[0], (int)sumRms_binning.size() - 1, &sumRms_binning[0]}, "bgorec_cosine", sumRms_leaf.c_str(), "simu_energy_w");

    auto h_BGOrec_sumRms_flast_20_100 = _fr_bgo_analysis.Define("corr_energy_gev", "energy_corr * 0.001")
                                            .Filter("corr_energy_gev >= 20 && corr_energy_gev<100")
                                            .Histo2D<double, double, double>({"h_BGOrec_sumRms_flast_20_100", "sumRms vs F_{last} correlation - 20 GeV - 100 GeV; sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast_binning.size() - 1, &flast_binning[0]}, sumRms_leaf.c_str(), fracLast_leaf, "simu_energy_w");
    auto h_BGOrec_sumRms_flast_100_250 = _fr_bgo_analysis.Define("corr_energy_gev", "energy_corr * 0.001")
                                             .Filter("corr_energy_gev >= 100 && corr_energy_gev<250")
                                             .Histo2D<double, double, double>({"h_BGOrec_sumRms_flast_100_250", "sumRms vs F_{last} correlation - 100 GeV - 250 GeV;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast_binning.size() - 1, &flast_binning[0]}, sumRms_leaf.c_str(), fracLast_leaf, "simu_energy_w");
    auto h_BGOrec_sumRms_flast_250_500 = _fr_bgo_analysis.Define("corr_energy_gev", "energy_corr * 0.001")
                                             .Filter("corr_energy_gev >= 250 && corr_energy_gev<500")
                                             .Histo2D<double, double, double>({"h_BGOrec_sumRms_flast_250_500", "sumRms vs F_{last} correlation - 250 GeV - 500 GeV;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast_binning.size() - 1, &flast_binning[0]}, sumRms_leaf.c_str(), fracLast_leaf, "simu_energy_w");
    auto h_BGOrec_sumRms_flast_500_1000 = _fr_bgo_analysis.Define("corr_energy_gev", "energy_corr * 0.001")
                                              .Filter("corr_energy_gev >= 500 && corr_energy_gev<1000")
                                              .Histo2D<double, double, double>({"h_BGOrec_sumRms_flast_500_1000", "sumRms vs F_{last} correlation - 500 GeV - 1 TeV;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast_binning.size() - 1, &flast_binning[0]}, sumRms_leaf.c_str(), fracLast_leaf, "simu_energy_w");
    auto h_BGOrec_sumRms_flast_1000_3000 = _fr_bgo_analysis.Define("corr_energy_gev", "energy_corr * 0.001")
                                               .Filter("corr_energy_gev >= 1000 && corr_energy_gev<3000")
                                               .Histo2D<double, double, double>({"h_BGOrec_sumRms_flast_1000_3000", "sumRms vs F_{last} correlation - 1 TeV - 3 TeV;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast_binning.size() - 1, &flast_binning[0]}, sumRms_leaf.c_str(), fracLast_leaf, "simu_energy_w");
    auto h_BGOrec_sumRms_flast_3000_10000 = _fr_bgo_analysis.Define("corr_energy_gev", "energy_corr * 0.001")
                                                .Filter("corr_energy_gev >= 3000 && corr_energy_gev<10000")
                                                .Histo2D<double, double, double>({"h_BGOrec_sumRms_flast_3000_10000", "sumRms vs F_{last} correlation - 3 TeV - 10 TeV ;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast_binning.size() - 1, &flast_binning[0]}, sumRms_leaf.c_str(), fracLast_leaf, "simu_energy_w");
    auto h_BGOrec_sumRms_flast_10000_20000 = _fr_bgo_analysis.Define("corr_energy_gev", "energy_corr * 0.001")
                                                 .Filter("corr_energy_gev >= 10000 && corr_energy_gev<20000")
                                                 .Histo2D<double, double, double>({"h_BGOrec_sumRms_flast_10000_20000", "sumRms vs F_{last} correlation - 10 TeV - 20 TeV ;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast_binning.size() - 1, &flast_binning[0]}, sumRms_leaf.c_str(), fracLast_leaf, "simu_energy_w");

    auto h_BGOrec_sumRms_flast_13_20_100 = _fr_bgo_analysis.Define("corr_energy_gev", "energy_corr * 0.001")
                                               .Filter("corr_energy_gev >= 20 && corr_energy_gev<100")
                                               .Histo2D<double, double, double>({"h_BGOrec_sumRms_flast_13_20_100", "sumRms vs F_{13} correlation - 20 GeV - 100 GeV ;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast13_binning.size() - 1, &flast13_binning[0]}, sumRms_leaf.c_str(), "fracLast_13", "simu_energy_w");
    auto h_BGOrec_sumRms_flast_13_100_250 = _fr_bgo_analysis.Define("corr_energy_gev", "energy_corr * 0.001")
                                                .Filter("corr_energy_gev >= 100 && corr_energy_gev<250")
                                                .Histo2D<double, double, double>({"h_BGOrec_sumRms_flast_13_100_250", "sumRms vs F_{13} correlation - 100 GeV - 250 GeV ;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast13_binning.size() - 1, &flast13_binning[0]}, sumRms_leaf.c_str(), "fracLast_13", "simu_energy_w");
    auto h_BGOrec_sumRms_flast_13_250_500 = _fr_bgo_analysis.Define("corr_energy_gev", "energy_corr * 0.001")
                                                .Filter("corr_energy_gev >= 250 && corr_energy_gev<500")
                                                .Histo2D<double, double, double>({"h_BGOrec_sumRms_flast_13_250_500", "sumRms vs F_{13} correlation - 250 GeV - 500 GeV ;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast13_binning.size() - 1, &flast13_binning[0]}, sumRms_leaf.c_str(), "fracLast_13", "simu_energy_w");
    auto h_BGOrec_sumRms_flast_13_500_1000 = _fr_bgo_analysis.Define("corr_energy_gev", "energy_corr * 0.001")
                                                 .Filter("corr_energy_gev >= 500 && corr_energy_gev<1000")
                                                 .Histo2D<double, double, double>({"h_BGOrec_sumRms_flast_13_500_1000", "sumRms vs F_{13} correlation - 500 GeV - 1 TeV ;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast13_binning.size() - 1, &flast13_binning[0]}, sumRms_leaf.c_str(), "fracLast_13", "simu_energy_w");
    auto h_BGOrec_sumRms_flast_13_1000_3000 = _fr_bgo_analysis.Define("corr_energy_gev", "energy_corr * 0.001")
                                                  .Filter("corr_energy_gev >= 1000 && corr_energy_gev<3000")
                                                  .Histo2D<double, double, double>({"h_BGOrec_sumRms_flast_13_1000_3000", "sumRms vs F_{13} correlation - 1 TeV - 3 TeV ;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast13_binning.size() - 1, &flast13_binning[0]}, sumRms_leaf.c_str(), "fracLast_13", "simu_energy_w");
    auto h_BGOrec_sumRms_flast_13_3000_10000 = _fr_bgo_analysis.Define("corr_energy_gev", "energy_corr * 0.001")
                                                   .Filter("corr_energy_gev >= 3000 && corr_energy_gev<10000")
                                                   .Histo2D<double, double, double>({"h_BGOrec_sumRms_flast_13_3000_10000", "sumRms vs F_{13} correlation - 3 TeV - 10 TeV ;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast13_binning.size() - 1, &flast13_binning[0]}, sumRms_leaf.c_str(), "fracLast_13", "simu_energy_w");
    auto h_BGOrec_sumRms_flast_13_10000_20000 = _fr_bgo_analysis.Define("corr_energy_gev", "energy_corr * 0.001")
                                                    .Filter("corr_energy_gev >= 10000 && corr_energy_gev<20000")
                                                    .Histo2D<double, double, double>({"h_BGOrec_sumRms_flast_13_10000_20000", "sumRms vs F_{13} correlation - 10 TeV - 20 TeV ;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast13_binning.size() - 1, &flast13_binning[0]}, sumRms_leaf.c_str(), "fracLast_13", "simu_energy_w");
    ...
    auto h_BGOrec_interceptX = _fr_bgo_analysis.Histo1D<double, double>({"h_BGOrec_interceptX", "BGOrec Intercept X", 100, -500, 500}, "BGOrec_interceptX", "simu_energy_w");
    auto h_BGOrec_interceptY = _fr_bgo_analysis.Histo1D<double, double>({"h_BGOrec_interceptY", "BGOrec Intercept Y", 100, -500, 500}, "BGOrec_interceptY", "simu_energy_w");

    auto h_xtrl_energy_int = _fr_bgo_analysis.Histo1D<double>({"h_xtrl_energy_int", "XTRL", 200, 0, 150}, "xtrl", "simu_energy_w");
    auto h_xtrl = _fr_bgo_analysis.Define("corr_energy_gev", "energy_corr * 0.001")
                      .Histo2D<double, double, double>({"h_xtrl", "XTRL", energy_nbins, &energy_binning[0], (int)xtrl_bins.size() - 1, &xtrl_bins[0]}, "corr_energy_gev", "xtrl", "simu_energy_w");
    ...
    for (int bin_idx = 1; bin_idx <= energy_nbins; ++bin_idx)
    {
        ...
        h_BGOrec_cosine_bin[bin_idx - 1] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                               .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                               .Histo1D<double, double>({(std::string("h_BGOrec_cosine_bin_") + std::to_string(bin_idx)).c_str(), (std::string("BGO Reco cosine - bin ") + std::to_string(bin_idx)).c_str(), 100, 0, 1}, "bgorec_cosine", "simu_energy_w");
        h_BGOrec_sumRms_bin[bin_idx - 1] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                               .Histo1D<double, double>({(std::string("h_BGOrec_sumRms_bin_") + std::to_string(bin_idx)).c_str(), (std::string("sumRms - bin ") + std::to_string(bin_idx)).c_str(), 100, sumrms_bin_lvalue, sumrms_bin_rvalue}, sumRms_leaf.c_str(), "simu_energy_w");
        h_BGOrec_sumRms_mean_bin[bin_idx - 1] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                    ...
                                                    .Histo1D<double, double>({(std::string("h_BGOrec_sumRms_mean_bin_") + std::to_string(bin_idx)).c_str(), (std::string("sumRms - bin ") + std::to_string(bin_idx)).c_str(), 80, 0, 100}, "sumRms_eff", "simu_energy_w");
        h_BGOrec_sumRms_bin_weight[bin_idx - 1] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                      ...
                                                      .Histo1D<double, double>({(std::string("h_BGOrec_sumRms_weight_bin_") + std::to_string(bin_idx)).c_str(), (std::string("sumRms weighted - bin ") + std::to_string(bin_idx)).c_str(), 50, 0, 100}, "sumRms_w", "simu_energy_w");
        h_BGOrec_sumRms_sumRms_weight[bin_idx - 1] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                         .Define("sumRms_w", computeSumRmsWeight, {"eLayer", "rmsLayer", "energy"})
                                                         .Define("sumRms_eff", "sumRms/(lastBGOLayer+1)")
                                                         .Histo2D<double, double, double>({(std::string("h_BGOrec_sumRms_sumRms_weight_bin_") + std::to_string(bin_idx)).c_str(), (std::string("sumRms_{mean} vs sumRms_{weighted} - bin ") + std::to_string(bin_idx) + std::string("; sumRms_{weighted} [mm]; sumRms_{mean} [mm]")).c_str(), 50, 0, 100, 50, 0, 100}, "sumRms_w", "sumRms_eff", "simu_energy_w");
        h_BGOrec_sumRms_bin_cosine[bin_idx - 1] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                      ...
                                                      .Histo1D<double, double>({(std::string("h_BGOrec_sumRms_cosine_bin_") + std::to_string(bin_idx)).c_str(), (std::string("sumRms cosine - bin ") + std::to_string(bin_idx) + std::string("; sumRms/cos(#theta); counts")).c_str(), 100, 0, 3000}, "sumRms_cosine", "simu_energy_w");
        h_BGOrec_sumRms_bin_cosine_cosine2D[bin_idx - 1] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                               .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                               .Define("sumRms_cosine", "sumRms/bgorec_cosine")
                                                               .Histo2D<double, double, double>({(std::string("h_BGOrec_sumRms_cosine_cosine2D_bin_") + std::to_string(bin_idx)).c_str(), (std::string("sumRms cosine - bin ") + std::to_string(bin_idx) + std::string("; cos(#theta); sumRms/cos(#theta)")).c_str(), 100, 0, 1, 100, 0, 3000}, "bgorec_cosine", "sumRms_cosine", "simu_energy_w");
        h_BGOrec_sumRms_bin_cosine_cosine2D_log[bin_idx - 1] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                                   .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                                   .Define("sumRms_cosine", "sumRms/bgorec_cosine")
                                                                   .Histo2D<double, double, double>({(std::string("h_BGOrec_sumRms_cosine_cosine2D_log_bin_") + std::to_string(bin_idx)).c_str(), (std::string("sumRms cosine - bin ") + std::to_string(bin_idx) + std::string("; cos(#theta); sumRms/cos(#theta)")).c_str(), (int)cosine_bins.size() - 1, &cosine_bins[0], (int)sumRms_cosine_bins.size() - 1, &sumRms_cosine_bins[0]}, "bgorec_cosine", "sumRms_cosine", "simu_energy_w");
        h_BGOrec_sumRms_bin_cosine2D[bin_idx - 1] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                        .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                        .Histo2D<double, double>({(std::string("h_BGOrec_sumRms_cosine2D_bin_") + std::to_string(bin_idx)).c_str(), (std::string("sumRms cosine - bin ") + std::to_string(bin_idx) + std::string("; cos(#theta); sumRms [mm]")).c_str(), 100, 0, 1, 100, sumrms2D_bin_lvalue, sumrms2D_bin_rvalue}, "bgorec_cosine", sumRms_leaf.c_str(), "simu_energy_w");
        if (!regularize_vars)
            h_BGOrec_sumRms_bin_cosine2D_log[bin_idx - 1] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                                .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                                .Histo2D<double, double>({(std::string("h_BGOrec_sumRms_cosine2D_log_bin_") + std::to_string(bin_idx)).c_str(), (std::string("sumRms cosine - bin ") + std::to_string(bin_idx) + std::string("; cos(#theta); sumRms [mm]")).c_str(), (int)cosine_bins.size() - 1, &cosine_bins[0], (int)sumRms_binning.size() - 1, &sumRms_binning[0]}, "bgorec_cosine", sumRms_leaf.c_str(), "simu_energy_w");
        h_BGOrec_sumRms_flast_bin[bin_idx - 1] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                     .Histo2D<double, double, double>({(std::string("h_BGOrec_sumRms_flast_bin_") + std::to_string(bin_idx)).c_str(), (std::string("sumRms vs F_{last} - bin ") + std::to_string(bin_idx) + std::string("; sumRms [mm]; F_{last}")).c_str(), (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast_binning.size() - 1, &flast_binning[0]}, sumRms_leaf.c_str(), fracLast_leaf, "simu_energy_w");
        h_BGOrec_sumRms_flast_13_bin[bin_idx - 1] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                        .Histo2D<double, double, double>({(std::string("h_BGOrec_sumRms_flast_13_bin_") + std::to_string(bin_idx)).c_str(), (std::string("sumRms vs F_{13} - bin ") + std::to_string(bin_idx) + std::string("; sumRms [mm]; F_{13}")).c_str(), (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast13_binning.size() - 1, &flast13_binning[0]}, sumRms_leaf.c_str(), "fracLast_13", "simu_energy_w");
        h_BGOrec_max_energy_ratio[bin_idx - 1] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                     ...
                                                     .Histo1D<double, double>({(std::string("h_BGOrec_max_energy_ratio_bin_") + std::to_string(bin_idx)).c_str(), (std::string("max energy ratio - bin ") + std::to_string(bin_idx)).c_str(), 100, 0, 1}, "max_energy_ratio", "simu_energy_w");
        h_BGOrec_ratio_last[bin_idx - 1] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                               .Histo1D<double, double>({(std::string("h_BGOrec_ratio_last_bin_") + std::to_string(bin_idx)).c_str(), (std::string("Energy Ratio Last Layer - bin ") + std::to_string(bin_idx)).c_str(), 100, flast_bin_lvalue, flast_bin_rvalue}, fracLast_leaf, "simu_energy_w");
        h_BGOrec_ratio_13[bin_idx - 1] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                             .Define("energy_ratio_13", "fracLayer[13]")
                                             .Histo1D<double, double>({(std::string("h_BGOrec_ratio_13_bin_") + std::to_string(bin_idx)).c_str(), (std::string("Energy Ratio 13th Layer - bin ") + std::to_string(bin_idx)).c_str(), 100, 0, 0.01}, "energy_ratio_13", "simu_energy_w");
        h_BGOrec_ratio_last_cosine[bin_idx - 1] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                      ...
                                                      .Histo1D<double, double>({(std::string("h_BGOrec_ratio_last_cosine_bin_") + std::to_string(bin_idx)).c_str(), (std::string("F_{last}/cos(#theta) - bin ") + std::to_string(bin_idx) + std::string("; F_{last}/cos(#theta); entries")).c_str(), 1000, 0, 0.3}, "frac_last_cosine", "simu_energy_w");
        h_BGOrec_ratio_last_cosine_cosine2D[bin_idx - 1] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                               .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                               .Define("frac_last_cosine", "fracLast/bgorec_cosine")
                                                               .Histo2D<double, double, double>({(std::string("h_BGOrec_ratio_last_cosine_cosine2D_bin_") + std::to_string(bin_idx)).c_str(), (std::string("F_{last}/cos(#theta) vs cos(#theta) - bin ") + std::to_string(bin_idx) + std::string("; cos(#theta); F_{last}/cos(#theta)")).c_str(), 100, 0, 1, 1000, 0, 0.3}, "bgorec_cosine", "frac_last_cosine", "simu_energy_w");
        h_BGOrec_ratio_last_cosine_cosine2D_log[bin_idx - 1] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                                   .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                                   .Define("frac_last_cosine", "fracLast/bgorec_cosine")
                                                                   .Histo2D<double, double, double>({(std::string("h_BGOrec_ratio_last_cosine_cosine2D_log_bin_") + std::to_string(bin_idx)).c_str(), (std::string("F_{last}/cos(#theta) vs cos(#theta) - bin ") + std::to_string(bin_idx) + std::string("; cos(#theta); F_{last}/cos(#theta)")).c_str(), (int)cosine_bins.size() - 1, &cosine_bins[0], (int)flast_cosine_binning.size() - 1, &flast_cosine_binning[0]}, "bgorec_cosine", "frac_last_cosine", "simu_energy_w");
        h_BGOrec_ratio_last_cosine2D[bin_idx - 1] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                        .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                        .Histo2D<double, double, double>({(std::string("h_BGOrec_ratio_last_cosine2D_bin_") + std::to_string(bin_idx)).c_str(), (std::string("Energy Ratio Last Layer vs cos(#theta) - bin ") + std::to_string(bin_idx) + std::string("; cos(#theta); F_{last}")).c_str(), 100, 0, 1, 100, flast_bin_lvalue, flast_bin_rvalue}, "bgorec_cosine", fracLast_leaf, "simu_energy_w");
        if (!regularize_vars)
        {
            h_BGOrec_ratio_last_cosine2D_log[bin_idx - 1] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                                .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                                .Histo2D<double, double, double>({(std::string("h_BGOrec_ratio_last_cosine2D_log_bin_") + std::to_string(bin_idx)).c_str(), (std::string("Energy Ratio Last Layer vs cos(#theta) - bin ") + std::to_string(bin_idx) + std::string("; cos(#theta); F_{last}")).c_str(), (int)cosine_bins.size() - 1, &cosine_bins[0], (int)flast_zoom_binning.size() - 1, &flast_zoom_binning[0]}, "bgorec_cosine", fracLast_leaf, "simu_energy_w");
            h_BGOrec_ratio_last_cosine2D_fdr[bin_idx - 1] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                                .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                                .Histo2D<double, double, double>({(std::string("h_BGOrec_ratio_last_cosine2D_fdr_bin_") + std::to_string(bin_idx)).c_str(), (std::string("Energy Ratio Last Layer vs cos(#theta) - bin ") + std::to_string(bin_idx) + std::string("; cos(#theta); F_{last}")).c_str(), 100, 0, 1, 1000, 0, 0.2}, "bgorec_cosine", fracLast_leaf, "simu_energy_w");
            h_BGOrec_ratio_last_cosine2D_fdr_log[bin_idx - 1] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                                    .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                                    .Histo2D<double, double, double>({(std::string("h_BGOrec_ratio_last_cosine2D_fdr_log_bin_") + std::to_string(bin_idx)).c_str(), (std::string("Energy Ratio Last Layer vs cos(#theta) - bin ") + std::to_string(bin_idx) + std::string("; cos(#theta); F_{last}")).c_str(), (int)cosine_bins.size() - 1, &cosine_bins[0], (int)flast_binning.size() - 1, &flast_binning[0]}, "bgorec_cosine", fracLast_leaf, "simu_energy_w");
        }
        ...
        _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
            .Foreach([&h_BGOrec_shower_profile, bin_idx](std::vector<double> &energy_frac, double energy_w) { 
                for (int lidx=0; lidx<DAMPE_bgo_nLayers; ++lidx)
                   h_BGOrec_shower_profile[bin_idx - 1]->Fill(lidx, energy_frac[lidx], energy_w); }, {"fracLayer", "simu_energy_w"});
        ...
        _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
            ...
            .Foreach([&h_BGOrec_shower_profile_upto_09, bin_idx](std::vector<double> &energy_frac, double energy_w) { 
                for (int lidx=0; lidx<DAMPE_bgo_nLayers; ++lidx)
                    h_BGOrec_shower_profile_upto_09[bin_idx - 1]->Fill(lidx, energy_frac[lidx], energy_w); }, {"fracLayer", "simu_energy_w"});
        ...
        _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
            ...
            .Foreach([&h_BGOrec_shower_profile_from_09, bin_idx](std::vector<double> &energy_frac, double energy_w) { 
                for (int lidx=0; lidx<DAMPE_bgo_nLayers; ++lidx)
                    h_BGOrec_shower_profile_from_09[bin_idx - 1]->Fill(lidx, energy_frac[lidx], energy_w); }, {"fracLayer", "simu_energy_w"});
        ...
        for (int ly = 0; ly < DAMPE_bgo_nLayers; ++ly)
        {
            ...
            h_BGOrec_rms_layer[bin_idx - 1][ly] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                      ...
                                                      .Histo1D<double, double>({(std::string("h_BGOrec_rms_layer_") + std::to_string(ly) + std::string("_bin_") + std::to_string(bin_idx)).c_str(), (std::string("RMS layer ") + std::to_string(ly) + std::string(" - bin ") + std::to_string(bin_idx)).c_str(), 100, 0, 500}, "rms_layer", "simu_energy_w");
            h_BGOrec_energy_ratio_layer[bin_idx - 1][ly] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                               ...
                                                               .Histo1D<double, double>({(std::string("h_BGOrec_energy_ratio_layer_") + std::to_string(ly) + std::string("_bin_") + std::to_string(bin_idx)).c_str(), (std::string("Energy Ratio layer ") + std::to_string(ly) + std::string(" - bin ") + std::to_string(bin_idx)).c_str(), 100, 0, 1}, "energy_ratio_layer", "simu_energy_w");
            h_BGOrec_energy_ratio_1R[bin_idx - 1][ly] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                            ...
                                                            .Histo1D<double, double>({(std::string("h_BGOrec_energy_ratio_1R_layer_") + std::to_string(ly) + std::string("_bin_") + std::to_string(bin_idx)).c_str(), (std::string("Energy Ratio 1MR layer ") + std::to_string(ly) + std::string(" - bin ") + std::to_string(bin_idx)).c_str(), 100, 0, 1}, "energy_ratio_1R_layer", "simu_energy_w");
            h_BGOrec_energy_ratio_2R[bin_idx - 1][ly] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                            ...
                                                            .Histo1D<double, double>({(std::string("h_BGOrec_energy_ratio_2R_layer_") + std::to_string(ly) + std::string("_bin_") + std::to_string(bin_idx)).c_str(), (std::string("Energy Ratio 2MR layer ") + std::to_string(ly) + std::string(" - bin ") + std::to_string(bin_idx)).c_str(), 100, 0, 1}, "energy_ratio_2R_layer", "simu_energy_w");
            h_BGOrec_energy_ratio_3R[bin_idx - 1][ly] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                            ...
                                                            .Histo1D<double, double>({(std::string("h_BGOrec_energy_ratio_3R_layer_") + std::to_string(ly) + std::string("_bin_") + std::to_string(bin_idx)).c_str(), (std::string("Energy Ratio 3MR layer ") + std::to_string(ly) + std::string(" - bin ") + std::to_string(bin_idx)).c_str(), 100, 0, 1}, "energy_ratio_3R_layer", "simu_energy_w");
            h_BGOrec_energy_ratio_5R[bin_idx - 1][ly] = _fr_bgo_analysis.Filter(bin_filter, {"energy_bin"})
                                                            ...
                                                            .Histo1D<double, double>({(std::string("h_BGOrec_energy_ratio_5R_layer_") + std::to_string(ly) + std::string("_bin_") + std::to_string(bin_idx)).c_str(), (std::string("Energy Ratio 5MR layer ") + std::to_string(ly) + std::string(" - bin ") + std::to_string(bin_idx)).c_str(), 100, 0, 1}, "energy_ratio_5R_layer", "simu_energy_w");
        }
    }

    // Extract Simu histos
    auto h_simu_energy = _fr_bgo_analysis.Define("simu_energy_gev", "simu_energy * 0.001")
                             .Histo1D<double, double>({"h_simu_energy", "Simu energy", energy_nbins, &energy_binning[0]}, "simu_energy_gev", "simu_energy_w");
    auto h_simu_energy_w = _fr_bgo_analysis.Histo1D<double>({"h_simu_energy_w", "Simu energy weight", 100, 0, 1}, "simu_energy_w");
    auto h_energy_diff = _fr_bgo_analysis.Define("simu_energy_gev", "simu_energy * 0.001")
                             ...
                             .Histo1D<double, double>({"h_energy_diff", "Simu vs Raw Reco BGO energy: Simu Energy - Raw Energy (GeV); counts", 100, 0, 100}, "energy_diff", "simu_energy_w");
    auto h_energy_diff_corr = _fr_bgo_analysis.Define("simu_energy_gev", "simu_energy * 0.001")
                                  ...
                                  .Histo1D<double, double>({"h_energy_diff_corr", "Simu vs Corrected Reco BGO energy: Simu Energy - Corrected Energy (GeV); counts", 100, -100, 100}, "energy_diff", "simu_energy_w");
    auto h_energy_diff2D = _fr_bgo_analysis.Define("simu_energy_gev", "simu_energy * 0.001")
                               ...
                               .Histo2D<double, double, double>({"h_energy_diff2D", "Energy Ratio; Real Energy (GeV); (Raw - Simu)/Simu", energy_nbins, &energy_binning[0], (int)energy_ratio_bins.size() - 1, &(energy_ratio_bins[0])}, "simu_energy_gev", "energy_ratio", "simu_energy_w");
    auto h_energy_diff2D_corr = _fr_bgo_analysis.Define("simu_energy_gev", "simu_energy * 0.001")
                                    ...
                                    .Histo2D<double, double, double>({"h_energy_diff2D_corr", "Energy Ratio; Real Energy (GeV); (Corr - Simu)/Simu", energy_nbins, &energy_binning[0], (int)energy_ratio_bins.size() - 1, &(energy_ratio_bins[0])}, "simu_energy_gev", "energy_ratio", "simu_energy_w");
    auto h_energy_unfold = _fr_bgo_analysis.Define("simu_energy_gev", "simu_energy * 0.001")
                               .Define("raw_energy_gev", "energy * 0.001")
                               .Histo2D<double, double, double>({"h_energy_unfold", "Energy Unfolding Matrix; Real Energy (GeV); Raw Energy (GeV)", energy_nbins, &energy_binning[0], energy_nbins, &energy_binning[0]}, "simu_energy_gev", "raw_energy_gev", "simu_energy_w");
    auto h_energy_unfold_corr = _fr_bgo_analysis.Define("simu_energy_gev", "simu_energy * 0.001")
                                    .Define("corr_energy_gev", "energy_corr * 0.001")
                                    .Histo2D<double, double, double>({"h_energy_unfold_corr", "Energy Unfolding Matrix; Real Energy (GeV); Corr Energy (GeV)", energy_nbins, &energy_binning[0], energy_nbins, &energy_binning[0]}, "simu_energy_gev", "corr_energy_gev", "simu_energy_w");
    auto h_simu_slopeX = _fr_bgo_analysis.Histo1D<double, double>({"h_simu_slopeX", "Simu Slope X", 100, -10, 10}, "simu_slope_x", "simu_energy_w");
    auto h_simu_slopeY = _fr_bgo_analysis.Histo1D<double, double>({"h_simu_slopeY", "Simu Slope Y", 100, -10, 10}, "simu_slope_y", "simu_energy_w");
    auto h_simu_interceptX = _fr_bgo_analysis.Histo1D<double, double>({"h_simu_interceptX", "Simu Intercept X", 100, -500, 500}, "simu_intercept_x", "simu_energy_w");
    auto h_simu_interceptY = _fr_bgo_analysis.Histo1D<double, double>({"h_simu_interceptY", "Simu Intercept Y", 100, -500, 500}, "simu_intercept_y", "simu_energy_w");
    auto h_simu_position_x = _fr_bgo_analysis.Define("simu_position_comp", "simu_position.fX")
                                 .Histo1D<double, double>({"h_simu_position_x", "Simu Position X; X [mm]", 100, -1500, 1500}, "simu_position_comp", "simu_energy_w");
    auto h_simu_position_y = _fr_bgo_analysis.Define("simu_position_comp", "simu_position.fY")
                                 .Histo1D<double, double>({"h_simu_position_y", "Simu Position Y; Y [mm]", 100, -1500, 1500}, "simu_position_comp", "simu_energy_w");
    auto h_simu_position_z = _fr_bgo_analysis.Define("simu_position_comp", "simu_position.fZ")
                                 .Histo1D<double, double>({"h_simu_position_z", "Simu Position Z; Z [mm]", 100, -1500, 1500}, "simu_position_comp", "simu_energy_w");
    ...
    auto h_simu_theta = _fr_bgo_analysis.Histo1D<double, double>({"h_simu_theta", "Simu #theta; #theta [deg]", 100, 0, 180}, "simu_theta", "simu_energy_w");
    auto h_simu_phi = _fr_bgo_analysis.Histo1D<double, double>({"h_simu_phi", "Simu #phi; #phi [deg]", 200, -180, 180}, "simu_phi", "simu_energy_w");
    auto h_simu_charge = _fr_bgo_analysis.Histo1D<double, double>({"h_simu_charge", "Simu charge;", 100, -2, 2}, "simu_charge", "simu_energy_w");
    auto h_simu_cosx = _fr_bgo_analysis.Histo1D<double, double>({"h_simu_cosx", "Simu #cos(x);", 100, -1, 1}, "simu_cos_x", "simu_energy_w");
    auto h_simu_cosy = _fr_bgo_analysis.Histo1D<double, double>({"h_simu_cosy", "Simu #cos(y);", 100, -1, 1}, "simu_cos_y", "simu_energy_w");
    ...
    auto h_stk_slopeX = _fr_stk_analysis.Histo1D<double, double>({"h_stk_slopeX", "Simu Slope X", 200, -10, 10}, "STK_bestTrack_slopeX", "simu_energy_w");
    auto h_stk_slopeY = _fr_stk_analysis.Histo1D<double, double>({"h_stk_slopeY", "Simu Slope Y", 200, -10, 10}, "STK_bestTrack_slopeY", "simu_energy_w");
    auto h_stk_interceptX = _fr_stk_analysis.Histo1D<double, double>({"h_stk_interceptX", "Simu Intercept X", 100, -500, 500}, "STK_bestTrack_interceptX", "simu_energy_w");
    ...
    for (int channel = 0; channel < DAMPE_NUD_channels; ++channel)
        h_NUD_adc[channel] = _fr_bgo_analysis.Define("nud_adc_channel", [channel](std::vector<int> nud_adc) { return nud_adc[channel]; }, {"NUD_ADC"})
                                 .Histo1D<int, double>({(std::string("h_NUD_adc_") + std::to_string(channel)).c_str(), (std::string("NUD ADC - channel ") + std::to_string(channel)).c_str(), 100, 0, 1000}, "nud_adc_channel", "simu_energy_w");
    auto h_NUD_total_adc = _fr_bgo_analysis.Histo1D<int, double>({"h_NUD_total_adc", "NUD Total ADC", 100, 0, 10000}, "NUD_total_ADC.nud_total_adc", "simu_energy_w");
    auto h_NUD_max_adc = _fr_bgo_analysis.Histo1D<int, double>({"h_NUD_max_adc", "NUD Max ADC", 100, 0, 1000}, "NUD_max_ADC.nud_max_adc", "simu_energy_w");
    auto h_NUD_max_channel = _fr_bgo_analysis.Histo1D<int, double>({"h_NUD_max_channel", "NUD Max Channel", 3, 0, 3}, "NUD_max_channel_ID.nud_max_channel_id", "simu_energy_w");

    // Preselected events based histos

    auto h_BGOrec_ps_raw_energy = _fr_preselected.Define("raw_energy_gev", "energy * 0.001")
                                      .Histo1D<double, double>({"h_BGOrec_ps_raw_energy", "BGO Raw energy", energy_nbins, &energy_binning[0]}, "raw_energy_gev", "simu_energy_w");
    auto h_BGOrec_ps_corr_energy = _fr_preselected.Define("corr_energy_gev", "energy_corr * 0.001")
                                       .Histo1D<double, double>({"h_BGOrec_ps_corr_energy", "BGO Corr energy", energy_nbins, &energy_binning[0]}, "corr_energy_gev", "simu_energy_w");
    auto h_BGOrec_ps_cosine = _fr_preselected.Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                  .Histo1D<double, double>({"h_BGOrec_ps_cosine", "BGO Reco cosine - Preselection", 100, 0, 1}, "bgorec_cosine", "simu_energy_w");

    auto h_BGOrec_ps_sumRms_bin_cosine2D_20_100 = _fr_preselected.Define("corr_energy_gev", "energy_corr * 0.001")
                                                      .Filter("corr_energy_gev >= 20 && corr_energy_gev<100")
                                                      .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                      .Histo2D<double, double, double>({"h_BGOrec_ps_sumRms_bin_cosine2D_20_100", "sumRms - cos(#theta) correlation 20 GeV - 100 GeV; cos(#theta); sumRms [mm]", (int)cosine_bins.size() - 1, &cosine_bins[0], (int)sumRms_binning.size() - 1, &sumRms_binning[0]}, "bgorec_cosine", sumRms_leaf.c_str(), "simu_energy_w");
    auto h_BGOrec_ps_sumRms_bin_cosine2D_100_250 = _fr_preselected.Define("corr_energy_gev", "energy_corr * 0.001")
                                                       .Filter("corr_energy_gev >= 100 && corr_energy_gev<250")
                                                       .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                       .Histo2D<double, double, double>({"h_BGOrec_ps_sumRms_bin_cosine2D_100_250", "sumRms - cos(#theta) correlation 20 GeV - 100 GeV; cos(#theta); sumRms [mm]", (int)cosine_bins.size() - 1, &cosine_bins[0], (int)sumRms_binning.size() - 1, &sumRms_binning[0]}, "bgorec_cosine", sumRms_leaf.c_str(), "simu_energy_w");
    auto h_BGOrec_ps_sumRms_bin_cosine2D_250_500 = _fr_preselected.Define("corr_energy_gev", "energy_corr * 0.001")
                                                       .Filter("corr_energy_gev >= 250 && corr_energy_gev<500")
                                                       .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                       .Histo2D<double, double, double>({"h_BGOrec_ps_sumRms_bin_cosine2D_250_500", "sumRms - cos(#theta) correlation 20 GeV - 100 GeV; cos(#theta); sumRms [mm]", (int)cosine_bins.size() - 1, &cosine_bins[0], (int)sumRms_binning.size() - 1, &sumRms_binning[0]}, "bgorec_cosine", sumRms_leaf.c_str(), "simu_energy_w");
    auto h_BGOrec_ps_sumRms_bin_cosine2D_500_1000 = _fr_preselected.Define("corr_energy_gev", "energy_corr * 0.001")
                                                        .Filter("corr_energy_gev >= 500 && corr_energy_gev<1000")
                                                        .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                        .Histo2D<double, double, double>({"h_BGOrec_ps_sumRms_bin_cosine2D_500_1000", "sumRms - cos(#theta) correlation 20 GeV - 100 GeV; cos(#theta); sumRms [mm]", (int)cosine_bins.size() - 1, &cosine_bins[0], (int)sumRms_binning.size() - 1, &sumRms_binning[0]}, "bgorec_cosine", sumRms_leaf.c_str(), "simu_energy_w");
    auto h_BGOrec_ps_sumRms_bin_cosine2D_1000_3000 = _fr_preselected.Define("corr_energy_gev", "energy_corr * 0.001")
                                                         .Filter("corr_energy_gev >= 1000 && corr_energy_gev<3000")
                                                         .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                         .Histo2D<double, double, double>({"h_BGOrec_ps_sumRms_bin_cosine2D_1000_3000", "sumRms - cos(#theta) correlation 20 GeV - 100 GeV; cos(#theta); sumRms [mm]", (int)cosine_bins.size() - 1, &cosine_bins[0], (int)sumRms_binning.size() - 1, &sumRms_binning[0]}, "bgorec_cosine", sumRms_leaf.c_str(), "simu_energy_w");
    auto h_BGOrec_ps_sumRms_bin_cosine2D_3000_10000 = _fr_preselected.Define("corr_energy_gev", "energy_corr * 0.001")
                                                          .Filter("corr_energy_gev >= 3000 && corr_energy_gev<10000")
                                                          .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                          .Histo2D<double, double, double>({"h_BGOrec_ps_sumRms_bin_cosine2D_3000_10000", "sumRms - cos(#theta) correlation 20 GeV - 100 GeV; cos(#theta); sumRms [mm]", (int)cosine_bins.size() - 1, &cosine_bins[0], (int)sumRms_binning.size() - 1, &sumRms_binning[0]}, "bgorec_cosine", sumRms_leaf.c_str(), "simu_energy_w");
    auto h_BGOrec_ps_sumRms_bin_cosine2D_10000_20000 = _fr_preselected.Define("corr_energy_gev", "energy_corr * 0.001")
                                                           .Filter("corr_energy_gev >= 10000 && corr_energy_gev<20000")
                                                           .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                           .Histo2D<double, double, double>({"h_BGOrec_ps_sumRms_bin_cosine2D_10000_20000", "sumRms - cos(#theta) correlation 20 GeV - 100 GeV; cos(#theta); sumRms [mm]", (int)cosine_bins.size() - 1, &cosine_bins[0], (int)sumRms_binning.size() - 1, &sumRms_binning[0]}, "bgorec_cosine", sumRms_leaf.c_str(), "simu_energy_w");

    auto h_BGOrec_ps_sumRms_flast_20_100 = _fr_preselected.Define("corr_energy_gev", "energy_corr * 0.001")
                                               .Filter("corr_energy_gev >= 20 && corr_energy_gev<100")
                                               .Histo2D<double, double, double>({"h_BGOrec_ps_sumRms_flast_20_100", "sumRms vs F_{last} correlation - 20 GeV - 100 GeV; sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast_binning.size() - 1, &flast_binning[0]}, sumRms_leaf.c_str(), fracLast_leaf, "simu_energy_w");
    auto h_BGOrec_ps_sumRms_flast_100_250 = _fr_preselected.Define("corr_energy_gev", "energy_corr * 0.001")
                                                .Filter("corr_energy_gev >= 100 && corr_energy_gev<250")
                                                .Histo2D<double, double, double>({"h_BGOrec_ps_sumRms_flast_100_250", "sumRms vs F_{last} correlation - 100 GeV - 250 GeV;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast_binning.size() - 1, &flast_binning[0]}, sumRms_leaf.c_str(), fracLast_leaf, "simu_energy_w");
    auto h_BGOrec_ps_sumRms_flast_250_500 = _fr_preselected.Define("corr_energy_gev", "energy_corr * 0.001")
                                                .Filter("corr_energy_gev >= 250 && corr_energy_gev<500")
                                                .Histo2D<double, double, double>({"h_BGOrec_ps_sumRms_flast_250_500", "sumRms vs F_{last} correlation - 250 GeV - 500 GeV;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast_binning.size() - 1, &flast_binning[0]}, sumRms_leaf.c_str(), fracLast_leaf, "simu_energy_w");
    auto h_BGOrec_ps_sumRms_flast_500_1000 = _fr_preselected.Define("corr_energy_gev", "energy_corr * 0.001")
                                                 .Filter("corr_energy_gev >= 500 && corr_energy_gev<1000")
                                                 .Histo2D<double, double, double>({"h_BGOrec_ps_sumRms_flast_500_1000", "sumRms vs F_{last} correlation - 500 GeV - 1 TeV;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast_binning.size() - 1, &flast_binning[0]}, sumRms_leaf.c_str(), fracLast_leaf, "simu_energy_w");
    auto h_BGOrec_ps_sumRms_flast_1000_3000 = _fr_preselected.Define("corr_energy_gev", "energy_corr * 0.001")
                                                  .Filter("corr_energy_gev >= 1000 && corr_energy_gev<3000")
                                                  .Histo2D<double, double, double>({"h_BGOrec_ps_sumRms_flast_1000_3000", "sumRms vs F_{last} correlation - 1 TeV - 3 TeV;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast_binning.size() - 1, &flast_binning[0]}, sumRms_leaf.c_str(), fracLast_leaf, "simu_energy_w");
    auto h_BGOrec_ps_sumRms_flast_3000_10000 = _fr_preselected.Define("corr_energy_gev", "energy_corr * 0.001")
                                                   .Filter("corr_energy_gev >= 3000 && corr_energy_gev<10000")
                                                   .Histo2D<double, double, double>({"h_BGOrec_ps_sumRms_flast_3000_10000", "sumRms vs F_{last} correlation - 3 TeV - 10 TeV ;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast_binning.size() - 1, &flast_binning[0]}, sumRms_leaf.c_str(), fracLast_leaf, "simu_energy_w");
    auto h_BGOrec_ps_sumRms_flast_10000_20000 = _fr_preselected.Define("corr_energy_gev", "energy_corr * 0.001")
                                                    .Filter("corr_energy_gev >= 10000 && corr_energy_gev<20000")
                                                    .Histo2D<double, double, double>({"h_BGOrec_ps_sumRms_flast_10000_20000", "sumRms vs F_{last} correlation - 10 TeV - 20 TeV ;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast_binning.size() - 1, &flast_binning[0]}, sumRms_leaf.c_str(), fracLast_leaf, "simu_energy_w");

    auto h_BGOrec_ps_sumRms_flast_13_20_100 = _fr_preselected.Define("corr_energy_gev", "energy_corr * 0.001")
                                                  .Filter("corr_energy_gev >= 20 && corr_energy_gev<100")
                                                  .Histo2D<double, double, double>({"h_BGOrec_ps_sumRms_flast_13_20_100", "sumRms vs F_{13} correlation - 20 GeV - 100 GeV ;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast13_binning.size() - 1, &flast13_binning[0]}, sumRms_leaf.c_str(), "fracLast_13", "simu_energy_w");
    auto h_BGOrec_ps_sumRms_flast_13_100_250 = _fr_preselected.Define("corr_energy_gev", "energy_corr * 0.001")
                                                   .Filter("corr_energy_gev >= 100 && corr_energy_gev<250")
                                                   .Histo2D<double, double, double>({"h_BGOrec_ps_sumRms_flast_13_100_250", "sumRms vs F_{13} correlation - 100 GeV - 250 GeV ;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast13_binning.size() - 1, &flast13_binning[0]}, sumRms_leaf.c_str(), "fracLast_13", "simu_energy_w");
    auto h_BGOrec_ps_sumRms_flast_13_250_500 = _fr_preselected.Define("corr_energy_gev", "energy_corr * 0.001")
                                                   .Filter("corr_energy_gev >= 250 && corr_energy_gev<500")
                                                   .Histo2D<double, double, double>({"h_BGOrec_ps_sumRms_flast_13_250_500", "sumRms vs F_{13} correlation - 250 GeV - 500 GeV ;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast13_binning.size() - 1, &flast13_binning[0]}, sumRms_leaf.c_str(), "fracLast_13", "simu_energy_w");
    auto h_BGOrec_ps_sumRms_flast_13_500_1000 = _fr_preselected.Define("corr_energy_gev", "energy_corr * 0.001")
                                                    .Filter("corr_energy_gev >= 500 && corr_energy_gev<1000")
                                                    .Histo2D<double, double, double>({"h_BGOrec_ps_sumRms_flast_13_500_1000", "sumRms vs F_{13} correlation - 500 GeV - 1 TeV ;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast13_binning.size() - 1, &flast13_binning[0]}, sumRms_leaf.c_str(), "fracLast_13", "simu_energy_w");
    auto h_BGOrec_ps_sumRms_flast_13_1000_3000 = _fr_preselected.Define("corr_energy_gev", "energy_corr * 0.001")
                                                     .Filter("corr_energy_gev >= 1000 && corr_energy_gev<3000")
                                                     .Histo2D<double, double, double>({"h_BGOrec_ps_sumRms_flast_13_1000_3000", "sumRms vs F_{13} correlation - 1 TeV - 3 TeV ;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast13_binning.size() - 1, &flast13_binning[0]}, sumRms_leaf.c_str(), "fracLast_13", "simu_energy_w");
    auto h_BGOrec_ps_sumRms_flast_13_3000_10000 = _fr_preselected.Define("corr_energy_gev", "energy_corr * 0.001")
                                                      .Filter("corr_energy_gev >= 3000 && corr_energy_gev<10000")
                                                      .Histo2D<double, double, double>({"h_BGOrec_ps_sumRms_flast_13_3000_10000", "sumRms vs F_{13} correlation - 3 TeV - 10 TeV ;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast13_binning.size() - 1, &flast13_binning[0]}, sumRms_leaf.c_str(), "fracLast_13", "simu_energy_w");
    auto h_BGOrec_ps_sumRms_flast_13_10000_20000 = _fr_preselected.Define("corr_energy_gev", "energy_corr * 0.001")
                                                       .Filter("corr_energy_gev >= 10000 && corr_energy_gev<20000")
                                                       .Histo2D<double, double, double>({"h_BGOrec_ps_sumRms_flast_13_10000_20000", "sumRms vs F_{13} correlation - 10 TeV - 20 TeV ;sumRms [mm]; F_{last}", (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast13_binning.size() - 1, &flast13_binning[0]}, sumRms_leaf.c_str(), "fracLast_13", "simu_energy_w");
    ...
    _fr_preselected.Foreach([&h_BGOrec_ps_bar_energy](std::vector<std::vector<double>> bar_energy, double energy_w) { 
            for (auto& bgo_ly : bar_energy)
                for(auto& energy : bgo_ly) 
                    h_BGOrec_ps_bar_energy->Fill(energy, energy_w); }, {"layerBarEnergy", "simu_energy_w"});

    auto h_BGOrec_ps_slopeX = _fr_preselected.Histo1D<double, double>({"h_BGOrec_ps_slopeX", "BGOrec Slope X", 200, -10, 10}, "BGOrec_slopeX", "simu_energy_w");
    auto h_BGOrec_ps_slopeY = _fr_preselected.Histo1D<double, double>({"h_BGOrec_ps_slopeY", "BGOrec Slope Y", 200, -10, 10}, "BGOrec_slopeY", "simu_energy_w");
    auto h_BGOrec_ps_interceptX = _fr_preselected.Histo1D<double, double>({"h_BGOrec_ps_interceptX", "BGOrec Intercept X", 100, -500, 500}, "BGOrec_interceptX", "simu_energy_w");
    auto h_BGOrec_ps_interceptY = _fr_preselected.Histo1D<double, double>({"h_BGOrec_ps_interceptY", "BGOrec Intercept Y", 100, -500, 500}, "BGOrec_interceptY", "simu_energy_w");

    auto h_xtrl_ps_energy_int = _fr_preselected.Histo1D<double>({"h_xtrl_ps_energy_int", "XTRL", 200, 0, 150}, "xtrl", "simu_energy_w");
    auto h_xtrl_ps = _fr_preselected.Define("corr_energy_gev", "energy_corr * 0.001")
                         .Histo2D<double, double, double>({"h_xtrl_ps", "XTRL", energy_nbins, &energy_binning[0], (int)xtrl_bins.size() - 1, &xtrl_bins[0]}, "corr_energy_gev", "xtrl", "simu_energy_w");
    ...
    for (int bin_idx = 1; bin_idx <= energy_nbins; ++bin_idx)
    {
        ...
        h_BGOrec_ps_sumRms_bin[bin_idx - 1] = _fr_preselected.Filter(bin_filter, {"energy_bin"})
                                                  .Histo1D<double, double>({(std::string("h_BGOrec_ps_sumRms_bin_") + std::to_string(bin_idx)).c_str(), (std::string("sumRms - bin ") + std::to_string(bin_idx)).c_str(), 100, sumrms_bin_lvalue, sumrms_bin_rvalue}, sumRms_leaf.c_str(), "simu_energy_w");
        h_BGOrec_ps_sumRms_mean_bin[bin_idx - 1] = _fr_preselected.Filter(bin_filter, {"energy_bin"})
                                                       .Define("num_layers", [](int last_layer) -> int { return last_layer + 1; }, {"lastBGOLayer"})
                                                       .Define("sumRms_eff", "sumRms/(lastBGOLayer+1)")
                                                       .Histo1D<double, double>({(std::string("h_BGOrec_ps_sumRms_mean_bin_") + std::to_string(bin_idx)).c_str(), (std::string("sumRms - bin ") + std::to_string(bin_idx)).c_str(), 80, 0, 100}, "sumRms_eff", "simu_energy_w");
        h_BGOrec_ps_sumRms_bin_weight[bin_idx - 1] = _fr_preselected.Filter(bin_filter, {"energy_bin"})
                                                         .Define("sumRms_w", computeSumRmsWeight, {"eLayer", "rmsLayer", "energy"})
                                                         .Histo1D<double, double>({(std::string("h_BGOrec_ps_sumRms_weight_bin_") + std::to_string(bin_idx)).c_str(), (std::string("sumRms weighted - bin ") + std::to_string(bin_idx)).c_str(), 50, 0, 100}, "sumRms_w", "simu_energy_w");
        h_BGOrec_ps_sumRms_sumRms_weight[bin_idx - 1] = _fr_preselected.Filter(bin_filter, {"energy_bin"})
                                                            .Define("sumRms_w", computeSumRmsWeight, {"eLayer", "rmsLayer", "energy"})
                                                            .Define("sumRms_eff", "sumRms/(lastBGOLayer+1)")
                                                            .Histo2D<double, double, double>({(std::string("h_BGOrec_ps_sumRms_sumRms_weight_bin_") + std::to_string(bin_idx)).c_str(), (std::string("sumRms_{mean} vs sumRms_{weighted} - bin ") + std::to_string(bin_idx) + std::string("; sumRms_{weighted} [mm]; sumRms_{mean} [mm]")).c_str(), 50, 0, 100, 50, 0, 100}, "sumRms_w", "sumRms_eff", "simu_energy_w");
        h_BGOrec_ps_sumRms_bin_cosine[bin_idx - 1] = _fr_preselected.Filter(bin_filter, {"energy_bin"})
                                                         .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                         .Define("sumRms_cosine", "sumRms/bgorec_cosine")
                                                         .Histo1D<double, double>({(std::string("h_BGOrec_ps_sumRms_cosine_bin_") + std::to_string(bin_idx)).c_str(), (std::string("sumRms cosine - bin ") + std::to_string(bin_idx) + std::string("; sumRms/cos(#theta); counts")).c_str(), 100, 0, 3000}, "sumRms_cosine", "simu_energy_w");
        h_BGOrec_ps_sumRms_bin_cosine_cosine2D[bin_idx - 1] = _fr_preselected.Filter(bin_filter, {"energy_bin"})
                                                                  .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                                  .Define("sumRms_cosine", "sumRms/bgorec_cosine")
                                                                  .Histo2D<double, double, double>({(std::string("h_BGOrec_ps_sumRms_cosine_cosine2D_bin_") + std::to_string(bin_idx)).c_str(), (std::string("sumRms cosine - bin ") + std::to_string(bin_idx) + std::string("; cos(#theta); sumRms/cos(#theta)")).c_str(), 100, 0, 1, 100, 0, 3000}, "bgorec_cosine", "sumRms_cosine", "simu_energy_w");
        ...
        h_BGOrec_ps_sumRms_bin_cosine2D[bin_idx - 1] = _fr_preselected.Filter(bin_filter, {"energy_bin"})
                                                           .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                           .Histo2D<double, double>({(std::string("h_BGOrec_ps_sumRms_cosine2D_bin_") + std::to_string(bin_idx)).c_str(), (std::string("sumRms cosine - bin ") + std::to_string(bin_idx) + std::string("; cos(#theta); sumRms [mm]")).c_str(), 100, 0, 1, 100, sumrms2D_bin_lvalue, sumrms2D_bin_rvalue}, "bgorec_cosine", sumRms_leaf.c_str(), "simu_energy_w");
        if (!regularize_vars)
        ...
        h_BGOrec_ps_sumRms_flast_13_bin[bin_idx - 1] = _fr_preselected.Filter(bin_filter, {"energy_bin"})
                                                           .Histo2D<double, double, double>({(std::string("h_BGOrec_ps_sumRms_flast_13_bin_") + std::to_string(bin_idx)).c_str(), (std::string("sumRms vs F_{13} - bin ") + std::to_string(bin_idx) + std::string("; sumRms [mm]; F_{13}")).c_str(), (int)sumRms_binning.size() - 1, &sumRms_binning[0], (int)flast13_binning.size() - 1, &flast13_binning[0]}, sumRms_leaf.c_str(), "fracLast_13", "simu_energy_w");
        h_BGOrec_ps_max_energy_ratio[bin_idx - 1] = _fr_preselected.Filter(bin_filter, {"energy_bin"})
                                                        .Define("max_energy_ratio", GetMaxEnergyRatio, {"fracLayer"})
                                                        .Histo1D<double, double>({(std::string("h_BGOrec_ps_max_energy_ratio_bin_") + std::to_string(bin_idx)).c_str(), (std::string("max energy ratio - bin ") + std::to_string(bin_idx)).c_str(), 100, 0, 1}, "max_energy_ratio", "simu_energy_w");
        h_BGOrec_ps_ratio_last[bin_idx - 1] = _fr_preselected.Filter(bin_filter, {"energy_bin"})
                                                  .Histo1D<double, double>({(std::string("h_BGOrec_ps_ratio_last_bin_") + std::to_string(bin_idx)).c_str(), (std::string("Energy Ratio Last Layer - bin ") + std::to_string(bin_idx)).c_str(), 100, flast_bin_lvalue, flast_bin_rvalue}, fracLast_leaf, "simu_energy_w");
        h_BGOrec_ps_ratio_13[bin_idx - 1] = _fr_preselected.Filter(bin_filter, {"energy_bin"})
                                                .Define("energy_ratio_13", "fracLayer[13]")
                                                .Histo1D<double, double>({(std::string("h_BGOrec_ps_ratio_13_bin_") + std::to_string(bin_idx)).c_str(), (std::string("Energy Ratio 13th Layer - bin ") + std::to_string(bin_idx)).c_str(), 100, 0, 0.01}, "energy_ratio_13", "simu_energy_w");
        h_BGOrec_ps_ratio_last_cosine[bin_idx - 1] = _fr_preselected.Filter(bin_filter, {"energy_bin"})
                                                         .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                         .Define("frac_last_cosine", "fracLast/bgorec_cosine")
                                                         .Histo1D<double, double>({(std::string("h_BGOrec_ps_ratio_last_cosine_bin_") + std::to_string(bin_idx)).c_str(), (std::string("F_{last}/cos(#theta) - bin ") + std::to_string(bin_idx) + std::string("; F_{last}/cos(#theta); entries")).c_str(), 1000, 0, 0.3}, "frac_last_cosine", "simu_energy_w");
        h_BGOrec_ps_ratio_last_cosine_cosine2D[bin_idx - 1] = _fr_preselected.Filter(bin_filter, {"energy_bin"})
                                                                  .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                                  .Define("frac_last_cosine", "fracLast/bgorec_cosine")
                                                                  .Histo2D<double, double, double>({(std::string("h_BGOrec_ps_ratio_last_cosine_cosine2D_bin_") + std::to_string(bin_idx)).c_str(), (std::string("F_{last}/cos(#theta) vs cos(#theta) - bin ") + std::to_string(bin_idx) + std::string("; cos(#theta); F_{last}/cos(#theta)")).c_str(), 100, 0, 1, 1000, 0, 0.3}, "bgorec_cosine", "frac_last_cosine", "simu_energy_w");
        ...
        if (!regularize_vars)
        {
            ...
            h_BGOrec_ps_ratio_last_cosine2D_fdr[bin_idx - 1] = _fr_preselected.Filter(bin_filter, {"energy_bin"})
                                                                .Define("bgorec_cosine", "BGOrec_trajectoryDirection2D.CosTheta()")
                                                                .Histo2D<double, double, double>({(std::string("h_BGOrec_ps_ratio_last_cosine2D_fdr_bin_") + std::to_string(bin_idx)).c_str(), (std::string("Energy Ratio Last Layer vs cos(#theta) - bin ") + std::to_string(bin_idx) + std::string("; cos(#theta); F_{last}")).c_str(), 100, 0, 1, 1000, 0, 0.2}, "bgorec_cosine", fracLast_leaf, "simu_energy_w");
        ...
        h_xtrl_ps_bin[bin_idx - 1] = _fr_preselected.Filter(bin_filter, {"energy_bin"})
                                         .Histo1D<double, double>({(std::string("h_xtrl_ps_bin_") + std::to_string(bin_idx)).c_str(), (std::string("XTRL - bin ") + std::to_string(bin_idx)).c_str(), 100, 0, 150}, "xtrl", "simu_energy_w");
        ...
        _fr_preselected.Filter(bin_filter, {"energy_bin"})
            ...
            for (auto& bgo_ly : bar_energy)
                for(auto& energy : bgo_ly) 
                    h_BGOrec_ps_bar_energy_bin[bin_idx -1]->Fill(energy, energy_w); }, {"layerBarEnergy", "simu_energy_w"});

        _fr_preselected.Filter(bin_filter, {"energy_bin"})
            .Foreach([&h_BGOrec_ps_shower_profile, bin_idx](std::vector<double> &energy_frac, double energy_w) { 
                for (int lidx=0; lidx<DAMPE_bgo_nLayers; ++lidx)
                   h_BGOrec_ps_shower_profile[bin_idx - 1]->Fill(lidx, energy_frac[lidx], energy_w); }, {"fracLayer", "simu_energy_w"});
        ...
        _fr_preselected.Filter(bin_filter, {"energy_bin"})
            ...
            .Foreach([&h_BGOrec_ps_shower_profile_upto_09, bin_idx](std::vector<double> &energy_frac, double energy_w) { 
                for (int lidx=0; lidx<DAMPE_bgo_nLayers; ++lidx)
                    h_BGOrec_ps_shower_profile_upto_09[bin_idx - 1]->Fill(lidx, energy_frac[lidx], energy_w); }, {"fracLayer", "simu_energy_w"});
        ...
        _fr_preselected.Filter(bin_filter, {"energy_bin"})
            ...
            .Foreach([&h_BGOrec_ps_shower_profile_from_09, bin_idx](std::vector<double> &energy_frac, double energy_w) { 
                for (int lidx=0; lidx<DAMPE_bgo_nLayers; ++lidx)
                    h_BGOrec_ps_shower_profile_from_09[bin_idx - 1]->Fill(lidx, energy_frac[lidx], energy_w); }, {"fracLayer", "simu_energy_w"});
        ...
        for (int ly = 0; ly < DAMPE_bgo_nLayers; ++ly)
        {
            ...
            h_BGOrec_ps_rms_layer[bin_idx - 1][ly] = _fr_preselected.Filter(bin_filter, {"energy_bin"})
                                                         .Define("rms_layer", GetLayerComponent, {"rmsLayer"})
                                                         .Histo1D<double, double>({(std::string("h_BGOrec_ps_rms_layer_") + std::to_string(ly) + std::string("_bin_") + std::to_string(bin_idx)).c_str(), (std::string("RMS layer ") + std::to_string(ly) + std::string(" - bin ") + std::to_string(bin_idx)).c_str(), 100, 0, 500}, "rms_layer", "simu_energy_w");
            h_BGOrec_ps_energy_ratio_layer[bin_idx - 1][ly] = _fr_preselected.Filter(bin_filter, {"energy_bin"})
                                                                  .Define("energy_ratio_layer", GetLayerComponent, {"fracLayer"})
                                                                  .Histo1D<double, double>({(std::string("h_BGOrec_ps_energy_ratio_layer_") + std::to_string(ly) + std::string("_bin_") + std::to_string(bin_idx)).c_str(), (std::string("Energy Ratio layer ") + std::to_string(ly) + std::string(" - bin ") + std::to_string(bin_idx)).c_str(), 100, 0, 1}, "energy_ratio_layer", "simu_energy_w");
            h_BGOrec_ps_energy_ratio_1R[bin_idx - 1][ly] = _fr_preselected.Filter(bin_filter, {"energy_bin"})
                                                               .Define("energy_1R_layer", GetLayerComponent, {"energy_1R_radius"})
                                                               .Define("energy_layer", GetLayerComponent, {"eLayer"})
                                                               .Define("energy_ratio_1R_layer", "energy_1R_layer/energy_layer")
                                                               .Histo1D<double, double>({(std::string("h_BGOrec_ps_energy_ratio_1R_layer_") + std::to_string(ly) + std::string("_bin_") + std::to_string(bin_idx)).c_str(), (std::string("Energy Ratio 1MR layer ") + std::to_string(ly) + std::string(" - bin ") + std::to_string(bin_idx)).c_str(), 100, 0, 1}, "energy_ratio_1R_layer", "simu_energy_w");
            h_BGOrec_ps_energy_ratio_2R[bin_idx - 1][ly] = _fr_preselected.Filter(bin_filter, {"energy_bin"})
                                                               .Define("energy_2R_layer", GetLayerComponent, {"energy_2R_radius"})
                                                               .Define("energy_layer", GetLayerComponent, {"eLayer"})
                                                               .Define("energy_ratio_2R_layer", "energy_2R_layer/energy_layer")
                                                               .Histo1D<double, double>({(std::string("h_BGOrec_ps_energy_ratio_2R_layer_") + std::to_string(ly) + std::string("_bin_") + std::to_string(bin_idx)).c_str(), (std::string("Energy Ratio 2MR layer ") + std::to_string(ly) + std::string(" - bin ") + std::to_string(bin_idx)).c_str(), 100, 0, 1}, "energy_ratio_2R_layer", "simu_energy_w");
            h_BGOrec_ps_energy_ratio_3R[bin_idx - 1][ly] = _fr_preselected.Filter(bin_filter, {"energy_bin"})
                                                               .Define("energy_3R_layer", GetLayerComponent, {"energy_3R_radius"})
                                                               .Define("energy_layer", GetLayerComponent, {"eLayer"})
                                                               .Define("energy_ratio_3R_layer", "energy_3R_layer/energy_layer")
                                                               .Histo1D<double, double>({(std::string("h_BGOrec_ps_energy_ratio_3R_layer_") + std::to_string(ly) + std::string("_bin_") + std::to_string(bin_idx)).c_str(), (std::string("Energy Ratio 3MR layer ") + std::to_string(ly) + std::string(" - bin ") + std::to_string(bin_idx)).c_str(), 100, 0, 1}, "energy_ratio_3R_layer", "simu_energy_w");
            h_BGOrec_ps_energy_ratio_5R[bin_idx - 1][ly] = _fr_preselected.Filter(bin_filter, {"energy_bin"})
                                                               .Define("energy_5R_layer", GetLayerComponent, {"energy_5R_radius"})
                                                               .Define("energy_layer", GetLayerComponent, {"eLayer"})
                                                               .Define("energy_ratio_5R_layer", "energy_5R_layer/energy_layer")
                                                               .Histo1D<double, double>({(std::string("h_BGOrec_ps_energy_ratio_5R_layer_") + std::to_string(ly) + std::string("_bin_") + std::to_string(bin_idx)).c_str(), (std::string("Energy Ratio 5MR layer ") + std::to_string(ly) + std::string(" - bin ") + std::to_string(bin_idx)).c_str(), 100, 0, 1}, "energy_ratio_5R_layer", "simu_energy_w");
        }
    }

    // Extract Simu histos
    auto h_simu_ps_energy = _fr_preselected.Define("simu_energy_gev", "simu_energy * 0.001")
                                .Histo1D<double, double>({"h_simu_ps_energy", "Simu energy", energy_nbins, &energy_binning[0]}, "simu_energy_gev", "simu_energy_w");
    auto h_simu_ps_energy_w = _fr_preselected.Histo1D<double>({"h_simu_ps_energy_w", "Simu energy weight", 100, 0, 1}, "simu_energy_w");
    auto h_energy_ps_diff = _fr_preselected.Define("simu_energy_gev", "simu_energy * 0.001")
                                .Define("raw_energy_gev", "energy * 0.001")
                                .Define("energy_diff", "simu_energy_gev - raw_energy_gev")
                                .Histo1D<double, double>({"h_energy_ps_diff", "Simu vs Raw Reco BGO energy: Simu Energy - Raw Energy (GeV); counts", 100, 0, 100}, "energy_diff", "simu_energy_w");
    auto h_energy_ps_diff_corr = _fr_preselected.Define("simu_energy_gev", "simu_energy * 0.001")
                                     .Define("corr_energy_gev", "energy_corr * 0.001")
                                     .Define("energy_diff", "simu_energy_gev - corr_energy_gev")
                                     .Histo1D<double, double>({"h_energy_ps_diff_corr", "Simu vs Corrected Reco BGO energy: Simu Energy - Corrected Energy (GeV); counts", 100, -100, 100}, "energy_diff", "simu_energy_w");
    auto h_energy_ps_diff2D = _fr_preselected.Define("simu_energy_gev", "simu_energy * 0.001")
                                  .Define("energy_ratio", "(energy - simu_energy)/simu_energy")
                                  .Histo2D<double, double, double>({"h_energy_ps_diff2D", "Energy Ratio; Real Energy (GeV); (Raw - Simu)/Simu", energy_nbins, &energy_binning[0], (int)energy_ratio_bins.size() - 1, &(energy_ratio_bins[0])}, "simu_energy_gev", "energy_ratio", "simu_energy_w");
    auto h_energy_ps_diff2D_corr = _fr_preselected.Define("simu_energy_gev", "simu_energy * 0.001")
                                       .Define("energy_ratio", "(energy_corr-simu_energy)/simu_energy")
                                       .Histo2D<double, double, double>({"h_energy_ps_diff2D_corr", "Energy Ratio; Real Energy (GeV); (Corr - Simu)/Simu", energy_nbins, &energy_binning[0], (int)energy_ratio_bins.size() - 1, &(energy_ratio_bins[0])}, "simu_energy_gev", "energy_ratio", "simu_energy_w");
    auto h_energy_ps_unfold = _fr_preselected.Define("simu_energy_gev", "simu_energy * 0.001")
                                  .Define("raw_energy_gev", "energy * 0.001")
                                  .Histo2D<double, double, double>({"h_energy_ps_unfold", "Energy Unfolding Matrix; Real Energy (GeV); Raw Energy (GeV)", energy_nbins, &energy_binning[0], energy_nbins, &energy_binning[0]}, "simu_energy_gev", "raw_energy_gev", "simu_energy_w");
    auto h_energy_ps_unfold_corr = _fr_preselected.Define("simu_energy_gev", "simu_energy * 0.001")
                                       .Define("corr_energy_gev", "energy_corr * 0.001")
                                       .Histo2D<double, double, double>({"h_energy_ps_unfold_corr", "Energy Unfolding Matrix; Real Energy (GeV); Corr Energy (GeV)", energy_nbins, &energy_binning[0], energy_nbins, &energy_binning[0]}, "simu_energy_gev", "corr_energy_gev", "simu_energy_w");
    auto h_simu_ps_slopeX = _fr_preselected.Histo1D<double, double>({"h_simu_ps_slopeX", "Simu Slope X", 100, -10, 10}, "simu_slope_x", "simu_energy_w");
    auto h_simu_ps_slopeY = _fr_preselected.Histo1D<double, double>({"h_simu_ps_slopeY", "Simu Slope Y", 100, -10, 10}, "simu_slope_y", "simu_energy_w");
    auto h_simu_ps_interceptX = _fr_preselected.Histo1D<double, double>({"h_simu_ps_interceptX", "Simu Intercept X", 100, -500, 500}, "simu_intercept_x", "simu_energy_w");
    auto h_simu_ps_interceptY = _fr_preselected.Histo1D<double, double>({"h_simu_ps_interceptY", "Simu Intercept Y", 100, -500, 500}, "simu_intercept_y", "simu_energy_w");
    auto h_simu_ps_position_x = _fr_preselected.Define("simu_position_comp", "simu_position.fX")
                                    .Histo1D<double, double>({"h_simu_ps_position_x", "Simu Position X; X [mm]", 100, -1500, 1500}, "simu_position_comp", "simu_energy_w");
    auto h_simu_ps_position_y = _fr_preselected.Define("simu_position_comp", "simu_position.fY")
                                    .Histo1D<double, double>({"h_simu_ps_position_y", "Simu Position Y; Y [mm]", 100, -1500, 1500}, "simu_position_comp", "simu_energy_w");
    auto h_simu_ps_position_z = _fr_preselected.Define("simu_position_comp", "simu_position.fZ")
                                    .Histo1D<double, double>({"h_simu_ps_position_z", "Simu Position Z; Z [mm]", 100, -1500, 1500}, "simu_position_comp", "simu_energy_w");
    ...
    auto h_simu_ps_theta = _fr_preselected.Histo1D<double, double>({"h_simu_ps_theta", "Simu #theta; #theta [deg]", 100, 0, 180}, "simu_theta", "simu_energy_w");
    auto h_simu_ps_phi = _fr_preselected.Histo1D<double, double>({"h_simu_ps_phi", "Simu #phi; #phi [deg]", 200, -180, 180}, "simu_phi", "simu_energy_w");
    auto h_simu_ps_charge = _fr_preselected.Histo1D<double, double>({"h_simu_ps_charge", "Simu charge;", 100, -2, 2}, "simu_charge", "simu_energy_w");
    auto h_simu_ps_cosx = _fr_preselected.Histo1D<double, double>({"h_simu_ps_cosx", "Simu #cos(x);", 100, -1, 1}, "simu_cos_x", "simu_energy_w");
    auto h_simu_ps_cosy = _fr_preselected.Histo1D<double, double>({"h_simu_ps_cosy", "Simu #cos(y);", 100, -1, 1}, "simu_cos_y", "simu_energy_w");
    auto h_simu_ps_cosz = _fr_preselected.Histo1D<double, double>({"h_simu_ps_cosz", "Simu #cos(z);", 100, -1, 1}, "simu_cos_z", "simu_energy_w");
    ...
    auto h_stk_ps_slopeX = _fr_preselected.Histo1D<double, double>({"h_stk_ps_slopeX", "Simu Slope X", 200, -10, 10}, "STK_bestTrack_slopeX", "simu_energy_w");
    auto h_stk_ps_slopeY = _fr_preselected.Histo1D<double, double>({"h_stk_ps_slopeY", "Simu Slope Y", 200, -10, 10}, "STK_bestTrack_slopeY", "simu_energy_w");
    auto h_stk_ps_interceptX = _fr_preselected.Histo1D<double, double>({"h_stk_ps_interceptX", "Simu Intercept X", 100, -500, 500}, "STK_bestTrack_interceptX", "simu_energy_w");
    auto h_stk_ps_interceptY = _fr_preselected.Histo1D<double, double>({"h_stk_ps_interceptY", "Simu Intercept Y", 100, -500, 500}, "STK_bestTrack_interceptY", "simu_energy_w");

    // Extract PSD charge histos
    auto h_psd_ps_chargeX = _fr_preselected.Histo1D<double, double>({"h_psd_ps_chargeX", "PSD Charge X", 100, 0, 20}, "PSD_chargeX", "simu_energy_w");
    auto h_psd_ps_chargeY = _fr_preselected.Histo1D<double, double>({"h_psd_ps_chargeY", "PSD Charge Y", 100, 0, 20}, "PSD_chargeY", "simu_energy_w");
    auto h_psd_ps_charge = _fr_preselected.Define("psd_charge", [](double psd_chargeX, double psd_chargeY) { return 0.5 * (psd_chargeX + psd_chargeY); }, {"PSD_chargeX", "PSD_chargeY"})
                               .Histo1D<double, double>({"h_psd_ps_charge", "PSD Charge", 100, 0, 20}, "psd_charge", "simu_energy_w");
    auto h_psd_ps_charge2D = _fr_preselected.Histo2D<double, double, double>({"h_psd_charge2D", "PSD Charge", 100, 0, 20, 100, 0, 20}, "PSD_chargeX", "PSD_chargeY", "simu_energy_w");

    auto h_psd_ps_selected_chargeX = _fr_preselected.Filter("evtfilter_psd_charge_cut==true")
                                         .Histo1D<double, double>({"h_psd_ps_selected_chargeX", "PSD Charge X", 100, 0, 20}, "PSD_chargeX", "simu_energy_w");
    auto h_psd_ps_selected_chargeY = _fr_preselected.Filter("evtfilter_psd_charge_cut==true")
                                         .Histo1D<double, double>({"h_psd_ps_selected_chargeY", "PSD Charge Y", 100, 0, 20}, "PSD_chargeY", "simu_energy_w");
    auto h_psd_ps_selected_charge = _fr_preselected.Filter("evtfilter_psd_charge_cut==true")
                                        .Define("psd_charge", [](double psd_chargeX, double psd_chargeY) { return 0.5 * (psd_chargeX + psd_chargeY); }, {"PSD_chargeX", "PSD_chargeY"})
                                        .Histo1D<double, double>({"h_psd_ps_selected_charge", "PSD Charge", 100, 0, 20}, "psd_charge", "simu_energy_w");
    auto h_psd_ps_selected_charge2D = _fr_preselected.Filter("evtfilter_psd_charge_cut==true")
                                          .Histo2D<double, double, double>({"h_psd_ps_selected_charge2D", "PSD Charge", 100, 0, 20, 100, 0, 20}, "PSD_chargeX", "PSD_chargeY", "simu_energy_w");

    // Extract STK charge histos
    auto h_stk_ps_chargeX = _fr_preselected.Histo1D<double, double>({"h_stk_ps_chargeX", "STK Charge X", 100, 0, 20}, "STK_chargeX", "simu_energy_w");
    auto h_stk_ps_chargeY = _fr_preselected.Histo1D<double, double>({"h_stk_ps_chargeY", "STK Charge Y", 100, 0, 20}, "STK_chargeY", "simu_energy_w");
    auto h_stk_ps_charge = _fr_preselected.Define("stk_charge", [](double stk_chargeX, double stk_chargeY) { return 0.5 * (stk_chargeX + stk_chargeY); }, {"STK_chargeX", "STK_chargeY"})
                               .Histo1D<double, double>({"h_stk_charge", "STK Charge", 100, 0, 20}, "stk_charge", "simu_energy_w");
    auto h_stk_ps_charge2D = _fr_preselected.Histo2D<double, double, double>({"h_stk_ps_charge2D", "STK Charge", 100, 0, 20, 100, 0, 20}, "STK_chargeX", "STK_chargeY", "simu_energy_w");

    auto h_stk_ps_selected_chargeX = _fr_preselected.Filter("evtfilter_stk_charge_cut==true")
                                         .Histo1D<double, double>({"h_stk_ps_selected_chargeX", "STK Charge X", 100, 0, 20}, "STK_chargeX", "simu_energy_w");
    auto h_stk_ps_selected_chargeY = _fr_preselected.Filter("evtfilter_stk_charge_cut==true")
                                         .Histo1D<double, double>({"h_stk_ps_selected_chargeY", "STK Charge Y", 100, 0, 20}, "STK_chargeY", "simu_energy_w");
    auto h_stk_ps_selected_charge = _fr_preselected.Filter("evtfilter_stk_charge_cut==true")
                                        .Define("stk_charge", [](double stk_chargeX, double stk_chargeY) { return 0.5 * (stk_chargeX + stk_chargeY); }, {"STK_chargeX", "STK_chargeY"})
                                        .Histo1D<double, double>({"h_stk_ps_selected_charge", "STK Charge", 100, 0, 20}, "stk_charge", "simu_energy_w");
    auto h_stk_ps_selected_charge2D = _fr_preselected.Filter("evtfilter_stk_charge_cut==true")
                                          .Histo2D<double, double, double>({"h_stk_ps_selected_charge2D", "STK Charge", 100, 0, 20, 100, 0, 20}, "STK_chargeX", "STK_chargeY", "simu_energy_w");
    ...
    for (int channel = 0; channel < DAMPE_NUD_channels; ++channel)
        h_NUD_ps_adc[channel] = _fr_preselected.Define("nud_adc_channel", [channel](std::vector<int> nud_adc) { return nud_adc[channel]; }, {"NUD_ADC"})
                                    .Histo1D<int, double>({(std::string("h_NUD_ps_adc_") + std::to_string(channel)).c_str(), (std::string("NUD ADC - channel ") + std::to_string(channel)).c_str(), 100, 0, 1000}, "nud_adc_channel", "simu_energy_w");
    auto h_NUD_ps_total_adc = _fr_preselected.Histo1D<int, double>({"h_NUD_ps_total_adc", "NUD Total ADC", 100, 0, 10000}, "NUD_total_ADC.nud_total_adc", "simu_energy_w");
    auto h_NUD_ps_max_adc = _fr_preselected.Histo1D<int, double>({"h_NUD_ps_max_adc", "NUD Max ADC", 100, 0, 1000}, "NUD_max_ADC.nud_max_adc", "simu_energy_w");
    auto h_NUD_ps_max_channel = _fr_preselected.Histo1D<int, double>({"h_NUD_ps_max_channel", "NUD Max Channel", 3, 0, 3}, "NUD_max_channel_ID.nud_max_channel_id", "simu_energy_w");

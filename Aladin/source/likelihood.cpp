    ...
    const bool _mc)
{
    ...
    {   
        ...
        likeprofile_elf_ang[l_idx] = (_data_fr.Filter(bin_filter, {"energy_bin"}).Define("mapval", map_filter, {"fraclastlayer_gauss"}).Define("likeval", loglike, {"mapval"}).Sum<double>("likeval"));
    }

	...
	const std::string wd)
{
	...
	auto h_energy_diff2D = static_cast<TH2D *>(inHisto.Get("BGO_Energy/h_energy_diff2D"));
	auto h_energy_unfold = static_cast<TH2D *>(inHisto.Get("BGO_Energy/h_energy_unfold"));
	...
	TH1D* h_background_under_xtrl_cut = nullptr;
	TH1D* h_background_over_xtrl_cut = nullptr;
	if (ancillary_cuts.compute_proton_background)
	{
		h_background_under_xtrl_cut = static_cast<TH1D *>(inHisto.Get("proton_background/h_background_under_xtrl_cut"));
		h_background_over_xtrl_cut = static_cast<TH1D *>(inHisto.Get("proton_background/h_background_over_xtrl_cut"));
	}

...
int main(int argc, char **argv)
{
	...
	opt.addUsage(" -t  --exposure              .......... <exposure_time>                                      .......... (*) DAMPE exposure time");
	...
	opt.addUsage("");
	opt.addUsage(" -y  --parallel              .......... <number_of_threads>                                  .......... Multithreading option");
	...
	if (opt.getValue("simu_electron") || opt.getValue('e')) 	input_args.e_simu_input_list = opt.getValue('e');
	if (opt.getValue("proton_fit") || opt.getValue('p')) 		input_args.p_background_fit = opt.getValue('p');
	...
	if (opt.getValue("exposure") || opt.getValue('t')) 			input_args.exposure = std::stod(opt.getValue('t'));

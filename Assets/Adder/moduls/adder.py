...
def compute_final_histos_mc(condor_dir_list, opts):
    ...
    for dIdx, tmp_dir in enumerate(condor_dir_list):
        ...
        h_BGOTrackContainment_cut_tmp_nw = rFile.Get("nw_histos/h_BGOTrackContainment_cut_nw")
        h_BGO_fiducial_cut_tmp_nw = rFile.Get("nw_histos/h_BGO_fiducial_cut_nw")
        ...
        h_geometric_maxElayer_cut_tmp_nw = rFile.Get("nw_histos/h_geometric_maxElayer_cut_nw")
        h_geometric_maxBarLayer_cut_tmp_nw = rFile.Get("nw_histos/h_geometric_maxBarLayer_cut_nw")
        h_geometric_BGOTrackContainment_cut_tmp_nw = rFile.Get("nw_histos/h_geometric_BGOTrackContainment_cut_nw")
        h_geometric_BGO_fiducial_cut_tmp_nw = rFile.Get("nw_histos/h_geometric_BGO_fiducial_cut_nw")
        h_geometric_all_cut_tmp_nw = rFile.Get("nw_histos/h_geometric_all_cut_nw")
        ...
        h_BGOfiducial_nBarLayer13_cut_tmp_nw = rFile.Get("nw_histos/h_BGOfiducial_nBarLayer13_cut_nw")
        h_BGOfiducial_maxRms_cut_tmp_nw = rFile.Get("nw_histos/h_BGOfiducial_maxRms_cut_nw")
        h_BGOfiducial_track_selection_cut_tmp_nw = rFile.Get("nw_histos/h_BGOfiducial_track_selection_cut_nw")
        h_BGOfiducial_psd_stk_match_cut_tmp_nw = rFile.Get("nw_histos/h_BGOfiducial_psd_stk_match_cut_nw")
        h_BGOfiducial_psd_charge_cut_tmp_nw = rFile.Get("nw_histos/h_BGOfiducial_psd_charge_cut_nw")
        h_BGOfiducial_stk_charge_cut_tmp_nw = rFile.Get("nw_histos/h_BGOfiducial_stk_charge_cut_nw")
        h_BGOfiducial_xtrl_cut_tmp_nw = rFile.Get("nw_histos/h_BGOfiducial_xtrl_cut_nw")
        h_BGOfiducial_all_cut_tmp_nw = rFile.Get("nw_histos/h_BGOfiducial_all_cut_nw")
        ...
        h_trigger_tmp_nw.SetDirectory(0)
        ...
        if dIdx == 0:
            ...
            for idx in range(n_energy_bins):
                ...
                histoName += str(idx)
                h_sumRms_cosine[idx] = h_sumRms_cosine_tmp[idx].Clone(histoName)

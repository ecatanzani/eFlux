    ...
    const char* output_file = "acceptance.root")
{
    ...
    TH1D* h_sumrms_low_energy                       = static_cast<TH1D*>(input_file->Get("h_sumrms_low_energy"));
    ...
    TH1D* h_stk_1_rm                                = static_cast<TH1D*>(input_file->Get("h_stk_1_rm"));
    ...
    TH1D* h_acc_sumrms_low_energy                       = static_cast<TH1D*>(h_sumrms_low_energy->Clone("h_acc_sumrms_low_energy"));
    ...
    TH1D* h_acc_stk_1_rm                                = static_cast<TH1D*>(h_stk_1_rm->Clone("h_acc_stk_1_rm"));
    ...
    h_acc_sumrms_low_energy                         ->GetYaxis()->SetTitle("acceptance [m^{2} sr]");
    ...
    h_acc_stk_1_rm                                  ->GetYaxis()->SetTitle("acceptance [m^{2} sr]");
    ...
    std::vector<double> acc_sumrms_low_energy                       (h_geometric_factor->GetNbinsX(), 0);
    ...
    std::vector<double> acc_stk_1_rm                                (h_geometric_factor->GetNbinsX(), 0);
    ...
    std::vector<double> acc_sumrms_low_energy_err                       (h_geometric_factor->GetNbinsX(), 0);
    ...
    std::vector<double> acc_stk_1_rm_err                                (h_geometric_factor->GetNbinsX(), 0);
    ...
    for (unsigned int idx=0; idx<energy.size(); ++idx)
    {
        ...
        acc_sumrms_low_energy[idx]                              = h_acc_sumrms_low_energy->GetBinContent(idx+1);
        acc_sumrms_low_energy_err[idx]                          = h_acc_sumrms_low_energy->GetBinError(idx+1);
        ...
        acc_stk_1_rm[idx]                                       = h_acc_stk_1_rm->GetBinContent(idx+1);
        acc_stk_1_rm_err[idx]                                   = h_acc_stk_1_rm->GetBinError(idx+1);
    ...
    TGraphErrors gr_acc_sumrms_low_energy                       ((int)geometric_factor.size(), &energy[0], &acc_sumrms_low_energy[0], &energy_err[0], &acc_sumrms_low_energy_err[0]);
    ...
    TGraphErrors gr_acc_stk_1_rm                                ((int)geometric_factor.size(), &energy[0], &acc_stk_1_rm[0], &energy_err[0], &acc_stk_1_rm_err[0]);
    ...
    gr_acc_sumrms_low_energy                        .SetName("gr_acc_sumrms_low_energy");
    ...
    gr_acc_stk_1_rm                                 .SetName("gr_acc_stk_1_rm");
    ...
    gr_acc_sumrms_low_energy                        .SetTitle("Acceptance - sumrms_low_energy");
    ...
    gr_acc_stk_1_rm                                 .SetTitle("Acceptance - STK 1 rm");
    ...
    gr_acc_sumrms_low_energy                        .GetYaxis()->SetTitle("acceptance [m^{2} sr]");
    ...
    gr_acc_stk_1_rm                                 .GetYaxis()->SetTitle("acceptance [m^{2} sr]");
